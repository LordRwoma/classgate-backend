    ...
    <div class="flex h-screen w-full">
        ...
        <div class="hidden lg:block lg:w-3/5 relative bg-[#2b454e]" x-data="{ activeSlide: 0 }"
            ...
            <div class="absolute bottom-8 left-8 z-20 flex flex-col justify-end items-start text-left">
                <div class="mb-4">
                    <h1 class="text-5xl font-extrabold text-white mb-2 drop-shadow-lg tracking-tight">Bergabunglah</h1>
                    <p class="text-lg text-blue-50 drop-shadow-md font-medium max-w-md">Mulai perjalanan mengajar yang lebih cerdas bersama ClassGate.</p>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-2/5 flex items-center justify-center p-6 relative">
            <div class="w-full max-w-sm">
                ...
                <div class="mb-3">
                    <h2 class="text-2xl font-bold text-[#2b454e] tracking-tight">Daftar ke ClassGate</h2>
                    <p class="text-[13px] text-gray-500 mt-0.5">Lengkapi data di bawah untuk mendaftar.</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-2.5">
                    ...
                    <div>
                        <label for="name" class="block text-[#1a2e35] font-extrabold text-xs mb-1">Nama Lengkap</label>
                    ...
                    <div>
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="contoh@belajar.id" 
                            class="block w-full border border-blue-200 focus:border-[#3072ed] focus:ring-[#3072ed] rounded-lg shadow-sm py-1.5 text-sm bg-[#f0f6ff] text-gray-900 placeholder-gray-400 font-medium transition-colors" />
                        <x-input-error :messages="$errors->get('email')" class="mt-1" />
                    </div>

                    <div>
                        <label for="password" class="block text-[#1a2e35] font-extrabold text-xs mb-1">Kata Sandi</label>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-[#1a2e35] font-extrabold text-xs mb-1">Konfirmasi Sandi</label>
                        <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" 
                            class="block w-full border border-blue-200 focus:border-[#3072ed] focus:ring-[#3072ed] rounded-lg shadow-sm py-1.5 text-sm bg-[#f0f6ff] text-gray-900 placeholder-gray-400 font-medium transition-colors" />
                        <x-input-error :messages="$errors->get('password_confirmation')" class="mt-1" />
                    </div>

                    <button type="submit" class="w-full flex justify-center py-1.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-[#3072ed] hover:bg-[#3162bf] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3072ed] transition-colors duration-200 mt-3">
                        Daftar Sekarang
                    </button>
                </form>
                ...
                <div class="mt-3 relative">
                    ...
                    <div class="relative flex justify-center text-[11px] font-medium leading-6">
                        <span class="bg-slate-50 px-3 text-gray-400">Atau daftar dengan cepat</span>
                    </div>
                </div>
                ...
                <div class="mt-3 text-center">
                    <p class="text-xs text-gray-600 mb-1">
                        Sudah memiliki akun? 
                        <a href="{{ route('login') }}" class="font-bold text-[#3072ed] hover:text-[#2d5299] hover:underline transition-all">Masuk di sini</a>
                    </p>
